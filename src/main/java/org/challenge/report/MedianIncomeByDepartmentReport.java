...
public class MedianIncomeByDepartmentReport implements Report {

  private List<Employee> employees;

  private String name;

  public MedianIncomeByDepartmentReport(List<Employee> employees, String name) {
  ...
  public List<String> getColumns() {
    return Arrays.asList("department", "income");
  }
